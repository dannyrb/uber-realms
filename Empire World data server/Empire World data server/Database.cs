...
namespace dataserver
{
    public class Database : IDisposable
    {
        ...
        {
            con = new MySqlConnection("Server=80.241.222.17;Database=rotmg;uid=empireworld;password=Cs308lala;Allow Zero Datetime=true"); //later will read from a registry value maybe
            con.Open();
        }
