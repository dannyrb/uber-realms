...
namespace wServer.realm.setpieces
{
    class Avatar : ISetPiece
    {
        ...
        static readonly byte Tile = (byte)XmlDatas.IdToType["Shatters Floor 1"];
        static readonly byte TileDark = (byte)XmlDatas.IdToType["Shatters Floor 6"];
        static readonly byte Stone = (byte)XmlDatas.IdToType["Shatters Floor 1"];
        ...
        public void RenderSetPiece(World world, IntPoint pos)
        {
            ...
            Entity Avatar = Entity.Resolve(0x00ff7);          //avatar!
            Avatar.Move(pos.X + Size / 2f, pos.Y + Size / 2f);
