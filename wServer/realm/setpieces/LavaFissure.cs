    ...
    class LavaFissure : ISetPiece
    {
        ...
        public void RenderSetPiece(World world, IntPoint pos)
        {
            ...
            for (int x = 0; x < Size; x++)      //Lava
            {
                ...
                double x_ = t / System.Math.Sqrt(2) - Math.Sin(t) / (SCALE * System.Math.Sqrt(2));
                double y1 = t / System.Math.Sqrt(2) - 2 * Math.Sin(t) / (SCALE * System.Math.Sqrt(2));
                double y2 = t / System.Math.Sqrt(2) + Math.Sin(t) / (SCALE * System.Math.Sqrt(2));
                y1 /= Math.PI / System.Math.Sqrt(2);
                y2 /= Math.PI / System.Math.Sqrt(2);
