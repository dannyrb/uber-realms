            ...
            spawn = new Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>()
        {
            { WmapTerrain.ShoreSand, Tuple.Create(
                100, new []
                {
                    ...
                    Tuple.Create("Scorpion Queen", 0.1),
                })
            },
            { WmapTerrain.ShorePlains, Tuple.Create(
                150, new []
                {
                    Tuple.Create("Bandit Leader", 0.1),
            ...
            { WmapTerrain.LowPlains, Tuple.Create(
                250, new []
                {
                    Tuple.Create("Hobbit Mage", 0.1),
                    Tuple.Create("Undead Hobbit Mage", 0.1),
            ...
            { WmapTerrain.LowForest, Tuple.Create(
                250, new []
                {
                    Tuple.Create("Elf Wizard", 0.1),
                    Tuple.Create("Goblin Mage", 0.1),
                    Tuple.Create("Easily Enraged Bunny", 0.1),
                    Tuple.Create("Forest Nymph", 0.1),
                })
            },
...
public void Tick(RealmTime time)
        ...
        {
            if (CountEnemies( "Cyclops God", "Red Demon",
        ...
        public void CloseRealm()
        {
            world.Timers.Add(new WorldTimer(8000, (w, t) =>
            {
                ...
                var oryxcastleWorld = RealmManager.AddWorld(new oryxcastle());
                foreach (var i in world.Players.Values)
                {
                    i.Client.SendPacket(new ReconnectPacket
                    {
                        Host = "",
                        Port = 2050,
                        GameId = oryxcastleWorld.Id,
                        Name = oryxcastleWorld.Name,
        ...
        static readonly Tuple<string, TauntData>[] criticalEnemies = new Tuple<string, TauntData>[]
        {
            ...
            Tuple.Create("Avatar of the Forgotten King", new TauntData
            {
                spawn = new[]
                {
                    ...
                    "My Avatar of the Forgotten Kings will take care of you peasants!"
                },
                numberOfEnemies = new[]
                {
                    "My {COUNT} Avatar will take care of you.",                 
                },
                final = new[]
                {
                    "Arhaa! Live brave until your meeting with my Avatar!",                
                },
                killed = new[]
                {
                    "UNACCEPTABLE! YOU WILL PAY {PLAYER}!",
                    "{PLAYER}, how dare you harm my Avatar!?",
                    "Regret your actions, {PLAYER} i will find you and kill you!"
                }
            }),
        };
        #endregion
