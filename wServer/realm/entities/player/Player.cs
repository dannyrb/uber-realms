    ...
    public partial class Player : Character, IContainer, IPlayer
    {
            ...
            : base((short)psr.Character.ObjectType, psr.Random)
        {
            ...
            switch (psr.Account.Rank)
            {
                ...
                case 2:
                    Name = "[Donater] " + psr.Account.Name; break;
                case 3:
        ...
        public override void Tick(RealmTime time)
        {
            ...
            Client.Player.Owner.Timers.Add(new WorldTimer(10000, (w, t) =>
            {
                Client.Save();
                ...
                if (p != null)
                {
                    ...
                    else
                    {
                        switch (entity.ObjectType) //handling default case for not found. Add more as implemented
                        {
                            ...
                            case 0x1909:
                                world = RealmManager.AddWorld(new Wyvern()); break;
                            case 0x296f:
                                world = RealmManager.AddWorld(new oryxcastle()); break;
                            case 0x297f:
                                world = RealmManager.AddWorld(new chamber()); break;
