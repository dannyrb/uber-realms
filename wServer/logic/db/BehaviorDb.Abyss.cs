        ...
        static _ Abyss = Behav()
            .Init(0x090a, Behaves("Archemon Malphas",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(800, new LootDef(0, 5, 1, 2,
							...
							Tuple.Create(0.01, (ILoot)new ItemLoot("Ocean Trench Key")),
                            Tuple.Create(0.75, (ILoot)new ItemLoot("Potion of Vitality")),
                            ...
                            Tuple.Create(0.75, (ILoot)new ItemLoot("Potion of Defense"))
                        ))
                )
            ))
                ...
                IfNot.Instance(
                    ...
                    loot: new LootBehavior(
                       new LootDef(0, 5, 0, 10,
                            ...
                            Tuple.Create(0.002, (ILoot)new ItemLoot("Captain America Armor")),
            ...
            .Init(0x0e1d, Behaves("Abyss Idol",
                new RunBehaviors(
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                       Tuple.Create(100, new LootDef(0, 5, 2, 10,
                            Tuple.Create(0.75, (ILoot)new ItemLoot("Potion of Defense")),
                            Tuple.Create(0.75, (ILoot)new ItemLoot("Potion of Vitality")),
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Wine Cellar Incantation")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Ocean Trench Key")),
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Amulet of Resurrection")),
                            Tuple.Create(0.0001, (ILoot)new ItemLoot("Captain America Armor")),
                            Tuple.Create(0.005, (ILoot)new ItemLoot("Demon Blade"))
            )))));
    }
