        ...
        static _ CubeGod = Behav()
            .Init(0x0d59, Behaves("Cube God",
                    ...
                    IfNot.Instance(
                        Once.Instance(
                            new RunBehaviors(
                                SpawnMinionImmediate.Instance(0x0d5a, 1, 1, 1),
                                SpawnMinionImmediate.Instance(0x0d5b, 1, 1, 1),
                                SpawnMinionImmediate.Instance(0x0d5c, 1, 1, 1)
                            )
                        ),
                        Rand.Instance(
                            Reproduce.Instance(0x0d5a, 4, 5000, 20),
                            Reproduce.Instance(0x0d5b, 10, 1000, 20),
                            Reproduce.Instance(0x0d5c, 10, 1000, 20)
                        )
                    ),
