        ...
        static _ RedDemon = Behav()
            .Init(0x668, Behaves("Red Demon",
                    ...
                    new RunBehaviors(
                        Once.Instance(
                            new RunBehaviors(
                                SpawnMinionImmediate.Instance(0x669, 1, 1, 1),
                                SpawnMinionImmediate.Instance(0x66a, 1, 1, 1),
                                SpawnMinionImmediate.Instance(0x66b, 1, 1, 1)
                            )
                        ),
                        new QueuedBehavior(
                            Rand.Instance(
                                SpawnMinionImmediate.Instance(0x669, 0, 0, 0),
                                SpawnMinionImmediate.Instance(0x66a, 0, 0, 0),
                                SpawnMinionImmediate.Instance(0x66b, 0, 0, 0),
