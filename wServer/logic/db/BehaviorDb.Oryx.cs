            ...
            .Init(0x0932, Behaves("Oryx the Mad God 2",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 5, 0, 8,
                            ...
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Ring of Unbound Wisdom")),
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Ring of Unbound Vitality")),
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Ring of Unbound Dexterity")),
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Ring of Unbound Speed")),
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Ring of Unbound Defense")),
                            Tuple.Create(0.006, (ILoot)new ItemLoot("Ring of Unbound Attack")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Ring of Unbound Magic")),
                            Tuple.Create(0.005, (ILoot)new ItemLoot("Potion of Oryx")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Ring of Unbound Health")),
            ...
            .Init(0x2001, Behaves("Oryx the Mad God 3",
                ...
                loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 5, 0, 8,
                            ...
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Ring of Unbound Magic")),
                            Tuple.Create(0.09, (ILoot)new ItemLoot("Ring of Unbound Attack")),
                            Tuple.Create(0.09, (ILoot)new ItemLoot("Ring of Unbound Defense")),
                            Tuple.Create(0.09, (ILoot)new ItemLoot("Ring of Unbound Speed")),
                            Tuple.Create(0.09, (ILoot)new ItemLoot("Ring of Unbound Dexterity")),
                            Tuple.Create(0.09, (ILoot)new ItemLoot("Ring of Unbound Vitality")),
                            Tuple.Create(0.09, (ILoot)new ItemLoot("Ring of Unbound Wisdom")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Tome of Noble Assault")),
                            Tuple.Create(0.05, (ILoot)new ItemLoot("Ring of Unbound Health")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Potion of Oryx")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Captain America Shield")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Captain America Sword")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Captain America Armor")),
                            Tuple.Create(0.01, (ILoot)new ItemLoot("Amulet of Resurrection")),
                            Tuple.Create(0.06, (ILoot)new ItemLoot("Wine Cellar Incantation"))
                ))),
                condBehaviors: new ConditionalBehavior[] {
            ...
            .Init(0x1740, Behaves("Oryx the Mad God 1",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 2, 0, 2,
                            ...
                            Tuple.Create(0.005, (ILoot)new ItemLoot("Potion of Oryx")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Ring of Unbound Health")),
                            Tuple.Create(0.005, (ILoot)new ItemLoot("Ring of Unbound Wisdom")),
                            Tuple.Create(0.005, (ILoot)new ItemLoot("Ring of Unbound Dexterity")),
                            Tuple.Create(0.005, (ILoot)new ItemLoot("Ring of Unbound Speed")),
                            Tuple.Create(0.005, (ILoot)new ItemLoot("Ring of Unbound Defense")),
                            Tuple.Create(0.005, (ILoot)new ItemLoot("Ring of Unbound Attack")),
                            Tuple.Create(0.001, (ILoot)new ItemLoot("Ring of Unbound Magic")),
                            Tuple.Create(0.0001, (ILoot)new ItemLoot("Captain America Shield")),
                            Tuple.Create(0.0001, (ILoot)new ItemLoot("Captain America Sword")),
                            Tuple.Create(0.0001, (ILoot)new ItemLoot("Captain America Armor")),
